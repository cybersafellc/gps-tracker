    ...
    <>
      ...
      <form className="space-y-4 md:space-y-6" onSubmit={(e) => hanldeLogin(e)}>
        ...
        {loadingButton ? (
          <button
            disabled
            className="flex justify-center items-center w-full text-white bg-cyan-800 cursor-progress focus:ring-4 focus:outline-none focus:ring-cyan-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-cyan-800"
          >
